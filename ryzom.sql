...
CREATE DATABASE `nel` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `nel`;
...
(12, 'ryzom_open', 'ds_open', 610, 'http://localhost:23001', NULL, 'localhost:49998', 'localhost:49999', 'ring_open', 'localhost:30000', 'localhost:40916', 'Open Domain');
...
(302, 12, 'localhost', 0, 'Open Shard', 0, 'ryzom_open', '', '', '', 0, 'ds_dev', '', 30);
...
CREATE DATABASE `nel_tool` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `nel_tool`;
...
(12, 'ryzom_open', 'localhost', 46700, '/home/ryzom/code/ryzom/server/save_shard/rrd_graphs', '', '', 'ryzom_open', 'mysql://shard@localhost/ring_open', 0, '', 'mysql://shard@localhost/atrium_forums');
...
CREATE DATABASE `ring_open` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ring_open`;
